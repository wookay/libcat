...
COMMANDS = %w{open help quit about clear history sleep} + %w{back cd commands echo enum events flash hit log ls manipulate new_objects openURL prompt properties pwd rm touch}
