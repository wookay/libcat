...
LOGGER_SERVER_PORT = open("#{DIR}/../libcat/Console/manager/ConsoleManager.m").read.lines.select { |line| line =~ /#define LOGGER_SERVER_PORT/ }.first.split(SPACE).last.to_i # 8081
